        ...
        <div class="pic-single-item">
            ...
            <?php if (is_countable($p_category) && count($p_category) > 0) : ?>
                <?php foreach ($p_category as $category) :
                    ...
                    <div>
                        <a href="<?= $url; ?>">
                            <img  class="img-responsive img_thumbnail"
                                 src="<?= $image; ?>"/>
                        </a>
                        <h4>
            ...
            <?php } else { ?>
                    ...
                    foreach ($entertainment_list as $key => $row) {
                        ...
                        $default_image = newsDefaultImage($row, array('imgwidth' => 502, 'imgheight' => 312));
                        ?>
                        ...
                        <?php if ($i == 1) { ?>
                                ...
                                <div class="country-newslist">
                                    <?php
                                        ...
                                        if (isset($row['id'])) {
                                        $url = site_url("article/{$row['id']}");
                                        $default_image = newsDefaultImage($row, array('imgwidth' => 61, 'imgheight' => 40));
                                    ?>
                                    <?php if ($i == 0) { ?>
