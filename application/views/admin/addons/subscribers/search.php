			...
			<div class="jarviswidget" <?php if(isset($_GET['search'])) echo ''; else echo 'data-widget-collapsed="true"'; ?> id="wid-id-0" data-widget-colorbutton="false" data-widget-editbutton="false" data-widget-fullscreenbutton="false">
				...
				<div>
					...
					<div class="widget-body">
						<form action="#subscribers/index/search/0/" method="get">
							<div class="row">
								<div class="col-md-4">
									<label>Subscribers Name</label>
									<input type="text" class="form-control" name="name" id="name" placeholder="Enter subscribers name" value="<?php if(isset($name)) echo $name; ?>">
								</div>
			
								<div class="col-md-4">
									<label>Subscribers Email</label>
									<input type="text" class="form-control" name="email" id="email" placeholder="Enter email address" value="<?php if(isset($email)) echo $email; ?>">
								</div>
