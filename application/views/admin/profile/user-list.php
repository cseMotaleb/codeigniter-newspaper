...
<script src="<?= base_url();?>assets/admin/js/plugin/jqgrid/jquery.jqGrid.min.js"></script>
<script src="<?= base_url();?>assets/admin/js/plugin/jqgrid/grid.locale-en.min.js"></script>
...
<script type="text/javascript">
	jQuery(document).ready(function() {
		...
		function processJson(data) {
		    ...
		    if(obj.mcode == 200) {
		    	$("#smart-form-zone").attr("action", "<?= site_url("admin/users/index"); ?>/" + obj.data_mode + "/" + obj.zone_id);
		...
		jQuery("#jqgrid").jqGrid({
			/*data : jqgrid_data,*/
			url:'<?= site_url("admin/users/cdata"); ?>',
			datatype : "json",
			mtype : "get", 
			height : 'auto',
 			loadComplete: function () {                                         
 			},
			colNames : ['ID', 'First Name', 'Last Name', 'E-mail', 'Password', 'Status'],
			colModel : [{
				name : 'id',
				index : 'id',
				sortable : true
			...
			editurl : "<?= site_url('admin/users/index/edit'); ?>",
