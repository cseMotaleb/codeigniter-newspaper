<div class="row">
	<div class="col-xs-12 col-sm-9 col-md-9 col-lg-9">
		<h1 class="page-title txt-color-blueDark">
			<i class="fa-fw fa fa-pencil-square-o"></i> Add-ons
		</h1>
	</div>
</div>
			...
			<div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<div>
					...
					<div class="widget-body no-padding">
						<form action="<?= site_url("controlpanel/addons/index/{$mode}/{$cur_id}"); ?>" id="smart-form" class="smart-form" method="post">
							<fieldset>
								<section>
									<label class="input">
									<input type="text" name="addon" placeholder="Add-on" value="<?php if(isset($addon['value'])) echo $addon['value']; ?>">
									<b class="tooltip tooltip-bottom-right">Please enter Add-on</b> </label>
								</section>
							</fieldset>
							<fieldset>
								<section>
...
<script type="text/javascript">
	...
	var pagefunction = function() {
		...
		function processJson(data) {
		    ...
		    if(obj.mcode == 200) {
		    	$("#smart-form").attr("action", "<?= site_url("controlpanel/addons/index"); ?>/" + obj.data_mode + "/" + obj.zone_id);
