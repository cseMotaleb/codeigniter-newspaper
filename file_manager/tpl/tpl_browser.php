...
<div id="right">
    <div id="toolbar">
        <div>
        <a href="kcact:upload"><?= $this->label("Upload") ?></a>
        <a href="kcact:refresh"><?= $this->label("Refresh") ?></a>
        <a href="kcact:settings"><?= $this->label("Settings") ?></a>
        <a href="kcact:maximize"><?= $this->label("Maximize") ?></a>
        <a href="kcact:about"><?= $this->label("About") ?></a>
        <div id="loading"></div>
        </div>
    </div>
    <div id="settings">
