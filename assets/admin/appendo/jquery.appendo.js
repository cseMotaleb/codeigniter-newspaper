...
jQuery(function(){ jQuery('table.add-image').appendo({ rows : $('table.add-image').data("rows") }); });
jQuery(function(){ jQuery('table.add-file').appendo({ rows : $('table.add-file').data("rows") }); });